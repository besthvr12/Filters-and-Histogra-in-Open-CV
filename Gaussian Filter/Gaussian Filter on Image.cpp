...
int main(int argc, char** argv)
{
	...
	String window_name = "Lenna";
	String window_name_blurred_with_3x3_kernel = "Lenna Blurred with 3 x 3 Gaussian Kernel";
	String window_name_blurred_with_5x5_kernel = "Lenna Blurred with 5 x 5 Gaussian Kernel";
